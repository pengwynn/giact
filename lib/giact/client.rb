module Giact
  class Client < Giact::Request
    ...
    def single_payment(payment_request)
      ...
      response = post("SinglePayment", payment_request.to_request_hash).perform
    ...
    def recurring_payments(payment_request)
      ...
      response = post("RecurringPayments", payment_request.to_request_hash).perform
      if reply = parse(response)
        Giact::PaymentReply.new(reply)
      else
    ...
    def installments_payments(payment_request)
      ...
      response = post("InstallmentsPayments", payment_request.to_request_hash).perform
      if reply = parse(response)
        Giact::PaymentReply.new(reply)
      else
